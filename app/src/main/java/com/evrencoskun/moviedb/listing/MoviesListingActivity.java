...
import com.evrencoskun.moviedb.details.MovieDetailsActivity;
import com.evrencoskun.moviedb.details.MovieDetailsFragment;
 ...
 * @author evrencoskun
 */
public class MoviesListingActivity extends AppCompatActivity implements MoviesListingFragment
        .Callback {
        ...
        if (findViewById(R.id.movie_details_container) != null) {
            ...
            if (savedInstanceState == null) {
                getSupportFragmentManager().beginTransaction().replace(R.id
                        .movie_details_container, new MovieDetailsFragment()).commit();
            }
        } else {
            twoPaneMode = false;
        }
    ...
    private void loadMovieFragment(Movie movie) {
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.movie_details_container,
                movieDetailsFragment, DETAILS_FRAGMENT).commit();
    }
}
