...
import com.evrencoskun.moviedb.BaseApplication;
import com.evrencoskun.moviedb.R;
import com.evrencoskun.moviedb.model.Constants;
 ...
 * @author evrencoskun
 */
public class MovieDetailsFragment extends Fragment implements IMovieDetailsView, View
        .OnClickListener {
    @Inject
    ...
    private void setToolbar() {
        collapsingToolbar.setContentScrimColor(ContextCompat.getColor(getContext(), R.color
                .colorPrimary));
    ...
    public void showDetails(Movie movie) {
        ...
        releaseDate.setText(String.format(getString(R.string.release_date), movie.getReleaseDate
                ()));
        rating.setText(String.format(getString(R.string.rating), String.valueOf(movie
                .getVoteAverage())));
    ...
    public void showTrailers(List<Video> trailers) {
        if (trailers.isEmpty()) {
            ...
            for (Video trailer : trailers) {
                ...
                picasso.load(Video.getThumbnailUrl(trailer)).resizeDimen(R.dimen.video_width, R
                        .dimen.video_height).centerCrop().placeholder(R.color.colorPrimary).into
                        (thumbView);
    ...
    public void showReviews(List<Review> reviews) {
        if (reviews.isEmpty()) {
            ...
            for (Review review : reviews) {
                ViewGroup reviewContainer = (ViewGroup) inflater.inflate(R.layout.review,
    ...
    public void showFavorited() {
        favorite.setImageDrawable(ContextCompat.getDrawable(getContext(), R.drawable
